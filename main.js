...
const ideasRef = database.ref('ideas'); // Reference to the 'ideas' path in your database
...
ideasRef.on('child_added', (snapshot) => {
    ...
    ideaDiv.dataset.firebaseKey = ideaKey; // Store Firebase key on the DOM element
    ...
    const ideaObject = {
        ...
        vx: ideaData.vx,
        vy: ideaData.vy,
        key: ideaKey // Store Firebase key in the idea object
    };
...
function createIdea(text) {
    ...
    ideasRef.push(ideaData); // Push data to Firebase
}
